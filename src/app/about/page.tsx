            ...
            <CardContent className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold mb-2 text-gray-700">フロントエンド</h3>
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-gray-700">バックエンド</h3>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-gray-700">AI / 外部サービス</h3>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-gray-700">記事抽出サービス</h3>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2 text-gray-700">インフラ</h3>
                    <div className="flex flex-wrap gap-2">
